...
const routes = [
  ...
  },
  {
    ...
    children: [
      { path: '', name: 'MyDrive', component: () => import('@/views/MyDrive.vue'), meta: { title: '我的网盘' } },
      ...
      { path: 'file-category', name: 'FileCategory', component: () => import('@/views/FileCategory.vue'), meta: { title: '文件分类', icon: 'FolderOpened' } },
      { path: 'shared', name: 'Shared', component: () => import('@/views/SharedFiles.vue'), meta: { title: '共享文件' } },
      { path: 'trash', name: 'Trash', component: () => import('@/views/Trash.vue'), meta: { title: '回收站' } },
